...
public record UserServiceErrorResponse(String code, String message, String timestamp, Map<String, String> errors) {
    ...
    public static UserServiceErrorResponse of(UserServiceErrorCode errorCode, Map<String, String> errors) {
        return new UserServiceErrorResponse(
